...
(function() {
    ...
    const i18n = {
        zh: {
            document1: "\n\n\nModo de coleta \n\nApós a abertura, o áudio convertido clicando no botão “Download” será coletado e um download de áudio será sintetizado quando o modo de coleta for fechado",
            document2: "\n\nDivisão automática：\n\nDividir texto longo em vários fragmentos próximos ao “tamanho do parágrafo”, e truncar apenas no “delimitador”, evitando que a frase seja truncada e afete o efeito de leitura",
            document3: "\n\n\n\nArraste e solte um arquivo txt nesta caixa para carregar um arquivo de texto",
            download: 'Baixar',
            downloading: 'Baixando',
            downloaded: 'Douwnload Completo',
            split: 'Divisão Automática',
            spliting: 'Dividindo',
            codec: 'Codec de Audio',
            saveSetting: 'Salvar Configurações',
            lengthWarning: 'O tamanho do download excede o limite gratuito, use o modo de coleta após dividir o texto',
            splitedMsg: "A divisão automática foi concluída\n\nUse o player abaixo para reproduzir ou desligue o modo de coleta para baixar arquivos de áudio",
            length: 'Comprimento do parágrafo',
            delimiter: 'Delimitador',
            collectionOn: 'Modo de coleta ON',
            collectionOff: 'modo de coleta OFF',
            received: 'Recebido',
            taskQueue: 'Segmentos restantes',
            profileName: 'Nome da configuração',
